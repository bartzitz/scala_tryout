...
object Calculation {
  ...
  def identifyFundingType(resolver: AccountResolver, sender: Sender): String = {
  ...
  def identifyFundingMode(fundingType: String, account: AccountClassification, resolver: AccountResolver): String = {
